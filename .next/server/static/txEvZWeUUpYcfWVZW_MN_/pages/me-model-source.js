...
function ModalAddSource(props) {
  ...
  var isQA = props.model.annotator === "question-answer";
  ...
  var fileType = [".xls", ".xlsx", ".csv", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "application/vnd.ms-excel"];
  var confUpload = {
    ...
    beforeUpload: function beforeUpload(file) {
      ...
      if (!fileType.includes(file.type) && !/(.xls|.xlsx|.csv)$/g.test(file.name)) {
  ...
  var ComponentSheetQA = function ComponentSheetQA() {
    if (state === null) return null;
    ...
    var handleSubmitQA = function handleSubmitQA() {
      if (!question) {
        external_antd_["message"].warning("Please select any check for submit to source.");
        return;
      }
    ...
    var steps = [{
      ...
      content: external_react_default.a.createElement(external_antd_["Table"], {
        className: "ant-custom table-sheet-wrapper",
        rowKey: "id",
        bordered: true,
        columns: external_lodash_default.a.map(columnsArr, function (item, key) {
          return {
            key: item,
            width: 200,
            title: external_react_default.a.createElement(external_antd_["Radio"], {
      ...
      content: external_react_default.a.createElement(external_antd_["Table"], {
        ...
        rowKey: "id",
        bordered: true,
        columns: external_lodash_default.a.map(external_lodash_default.a.without(columnsArr, question), function (item, key) {
          return {
            key: item,
            width: 200,
            title: external_react_default.a.createElement(external_antd_["Radio"], {
      ...
      content: external_react_default.a.createElement(external_antd_["Table"], {
        ...
        rowKey: "id",
        bordered: true,
        columns: external_lodash_default.a.map([question, answer], function (item, key) {
          return {
            key: item,
            width: 200,
    ...
    return external_react_default.a.createElement("div", {
      className: "table-sheet"
    }, external_react_default.a.createElement(external_antd_["Steps"], {
      current: current
    }, steps.map(function (item) {
      return external_react_default.a.createElement(external_antd_["Steps"].Step, {
        key: item.title,
        title: item.title
      });
    })), external_react_default.a.createElement("div", {
    ...
    }, current < steps.length - 1 && external_react_default.a.createElement("div", {
      className: "d-flex justify-content-center",
      style: {
        marginTop: 16
      }
      ...
      onClick: next,
      disabled: state.length === null
    }, "Next")), current === steps.length - 1 && external_react_default.a.createElement("div", {
      className: "d-flex justify-content-center",
      style: {
        marginTop: 16
      }
      ...
      disabled: state.length === null
    }, "Submit")), current > 0 && external_react_default.a.createElement("div", {
      className: "d-flex justify-content-center",
      style: {
        marginTop: 16
      }
  ...
  return external_react_default.a.createElement(external_antd_["Modal"], {
    ...
    tip: loadingText,
    spinning: loading
  }, state !== null && !isQA && external_react_default.a.createElement(ComponentSheet, null), state !== null && isQA && external_react_default.a.createElement(ComponentSheetQA, null), state === null && external_react_default.a.createElement(ComponentUpload, null))));
}
...
function ModelSource(props) {
  ...
  var _useState = Object(external_react_["useState"])(external_socket_io_client_default.a.connect("http://localhost:3000")),
      _useState2 = Object(slicedToArray["a" /* default */])(_useState, 2),
      socket = _useState2[0],
  ...
  var _useState3 = Object(external_react_["useState"])(props.source.json),
      _useState4 = Object(slicedToArray["a" /* default */])(_useState3, 2),
      state = _useState4[0],
  ...
  var selectAll = function selectAll() {
    ...
    setSelected(external_lodash_default.a.map(state, function (item, index) {
      return index;
    }));
  };
  ...
  var ComponentListItem = function ComponentListItem(props) {
    var data = props.dataSource;

    if (external_lodash_default.a.isObject(data)) {
      var keys = external_lodash_default.a.keys(data);

      return external_react_default.a.createElement("div", null, keys.map(function (item) {
        return external_react_default.a.createElement(external_antd_["Typography"].Paragraph, {
          ellipsis: {
            rows: 1
          }
        }, external_react_default.a.createElement("b", null, external_lodash_default.a.upperFirst(item), ": "), " ", data[item]);
      }));
    }
    ...
    return external_react_default.a.createElement(external_antd_["Checkbox"].Group, {
      ...
      renderItem: function renderItem(item, index) {
        return external_react_default.a.createElement(external_antd_["List"].Item, {
          ...
          description: external_react_default.a.createElement(ComponentListItem, {
            dataSource: item
          })
        })));
      }
